...
<link type="text/css" rel="stylesheet" href="./css/clientOrder.css">
</head>
        ...
        <article>
            ...
            <div style="display:flex;">
                ...
                <div id="payDetailLayor">
                    ...
                    <p>
                    <div class="payDetail">
                        <div class="payDetailLeft"><strong>총 결제 금액</strong></div>
                        <div class="payDetailRight">
                            12 만원</div>
                    </div>
                </p>
            ...
            <div id="pay">
                ...
                <div>
                    <br>
                    <input type="radio" name="pay" value="account">계좌입금
